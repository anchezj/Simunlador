...
<head>
	...
	<link rel="stylesheet" type="text/css" href="perfilempleado.css">
	<title></title>
</head>
<body>
  <header class="header">
    <div class="menu">
      <nav>
          <ul>
            ...
            <li><a></a></li>
            <li><a></a></li>
            <li><a href="empleadophp.php">Atras</a></li>
...
<!--                   <a href="inicio_sesion.php">Cerrar sesion</a></li> -->
	...
	<?php
			...
			echo "<font face= impact size= 6> Bienvenid@ <br>emplad@  <br>".$usuario."</font><br>";
			// echo $fotosesion;
	?>
	<?php
...
<table>
	<div class="menu1">
		...
		if(isset($_POST['insertar']))
			...
			if ($ejecutar)
				{
					header("Location: perfilempleado.php?");
				}
